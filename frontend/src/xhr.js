...
export function xhr( type /* PUT, GET, POST, DELETE */, url, headers = {}, data = undefined, progressCB = (o, body, AbortFunc) => {}, options = {} ) {
  let ___XMLHttpRequest = ((typeof module !== 'undefined') && module.exports) ? module.exports.__XMLHttpRequest : XMLHttpRequest;
